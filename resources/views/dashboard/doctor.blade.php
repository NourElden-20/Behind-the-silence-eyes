...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="{{ route('reports.dashboard') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
        ...
        <div class="card shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-auto">
                        <div class="p-2 rounded text-white" style="background:#2563eb;">
        ...
        <div class="card shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-auto">
                        <div class="p-2 rounded text-white" style="background:#22c55e;">
        ...
        <div class="card shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-auto">
                        <div class="p-2 rounded text-white" style="background:#a855f7;">
        ...
        <div class="card shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-auto">
                        <div class="p-2 rounded text-white" style="background:#f97316;">
...
<div class="row g-3 mb-4">
    ...
    <div class="col-md-6">
        <a href="{{ route('patients.index') }}" class="btn p-4 w-100 text-start text-white"
            style="background:#22c55e; border-radius:16px;">
            <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="1.5"
                class="d-block mb-3">
