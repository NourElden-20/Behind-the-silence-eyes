        ...
        <div class="mx-auto" style="max-width: 900px;">
            ...
            <div class="bg-white rounded border p-4">
                ...
                <form action="{{ route('patients.store') }}" method="POST">
                    ...
                    <!-- DoctorID -->
                    <div class="mb-3">
                        <label class="form-label fw-medium" style="font-size: 0.85rem;">Doctor ID
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                            placeholder="Enter Doctor's full name" value="{{ old('name') }}">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-medium" style="font-size: 0.85rem;">Phone Number
                                <span class="text-danger">*</span>
                            </label>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="medical_history" class="form-control @error('medical_history') is-invalid @enderror"
                            rows="4"
                            placeholder="Enter doctor's medical specialization or experience">{{ old('medical_history') }}</textarea>
                        ...
                        <div class="form-text" style="font-size: 0.78rem;">
                            Enter doctor's professional notes or specialization details
                        </div>
