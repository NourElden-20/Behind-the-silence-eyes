...
<div class="row justify-content-between pb-2">
    ...
    <div class="">
        <a href="{{ route('patients.create') }}" class="btn btn-primary active" role="button" aria-pressed="true">+ Add
            New Patient</a>
    </div>
</div>
    ...
    <div class="card border-dark col-lg-6  mt-2" style="max-width: 18rem;">
        ...
        <div class="card-body text-dark ">
            ...
            <div class="d-flex justify-content-between ">
                ...
                <a href="{{ route('predictions.create', $patient->id) }}" class="btn btn-outline-success">Diagnose</a>
                <form action="{{ route('patients.delete', $patient->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button type="button" class="btn btn-outline-danger btn-delete-patient">
