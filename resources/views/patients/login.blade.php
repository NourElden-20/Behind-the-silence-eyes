    ...
    <div class="min-vh-100 w-100 d-flex flex-column align-items-center justify-content-center px-3"
        ...
        <div class="card border-0 p-5 w-100"
            ...
            <div class="text-center mb-3">
                <a href="{{ route('login') }}" class="text-decoration-none" style="color:#1a56db; font-size:14px;">← Back to
                    Doctor Login</a>
            </div>
            <h2 class="fw-bold mb-4" style="color:#0f172a;">Patient Login</h2>
            ...
            <form action="/patient-login" method="POST">
                ...
                {{-- National ID --}}
                <div class="mb-4">
                    <label class="form-label fw-bold" style="color:#0f172a;">National ID</label>
                    <div class="input-group border overflow-hidden"
                        ...
                        <input type="text" name="national_id"
                            class="form-control bg-white border-0 shadow-none ps-1 @error('national_id') is-invalid @enderror"
